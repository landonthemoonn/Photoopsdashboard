  ...
  return (
    <div>
      <div className="grid grid-cols-4 gap-4 mb-4">
        <StatCard title="Macs Online" value={live ? String(online) : '—'} subtitle={live ? `of ${total} total devices` : 'Enter Jamf credentials in Settings'} icon={Wifi} variant="yellow" delay={0} />
        ...
        <StatCard title="Needs Update" value={live ? String(needsUpdate) : '—'} subtitle={live ? `of ${total} devices` : 'Enter Jamf credentials in Settings'} icon={HardDrive} variant="neutral" delay={0.1} />
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        <StatCard title="System Health" value={live && healthPct !== null ? `${healthPct}%` : '—'} subtitle="Devices on latest macOS" icon={AlertCircle} variant="charcoal" delay={0.2} />
        <OSDistributionChart />
        <QuickLinks />
      </div>
